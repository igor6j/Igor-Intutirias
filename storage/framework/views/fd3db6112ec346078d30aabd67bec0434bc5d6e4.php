...
<body>
	<div align="center">
		...
		<form action="<?php echo e(route('guardar_persona')); ?>"method="POST">
		<?php echo csrf_field(); ?>
			<table border="1">
				<tr>
...
</html><?php /**PATH C:\xampp\htdocs\cursolaravel\resources\views/personas/registrar.blade.php ENDPATH**/ ?>